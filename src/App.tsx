      ...
      <main className="flex-1 container mx-auto px-4 py-4">
        <div className="flex flex-col xl:flex-row items-start justify-center gap-2 max-w-5xl mx-auto">
          ...
          <div className="w-full xl:w-auto">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700 max-w-md mx-auto">
              <h2 className="text-xl font-medium mb-4 text-center">Interactive Color Wheel</h2>
